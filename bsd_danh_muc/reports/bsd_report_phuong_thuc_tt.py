        ...
        for dot in dot_tt_ids.sorted('bsd_stt'):
            ...
            # Tạo đợt thanh toán theo dự kiến bàn giao
                ...
                list_ltt.append((
                    ...
                    dot_dkbg.bsd_dot_ky_hd,
                    dot_dkbg.bsd_dot_cuoi,
                    dot_dkbg.bsd_tinh_pql,
                    dot_dkbg.bsd_tinh_pbt
                ))
            ...
            # Tạo đợt thanh toán cuối
                ...
                list_ltt.append((
                    ...
                    dot_cuoi.bsd_dot_ky_hd,
                    dot_cuoi.bsd_dot_cuoi,
                    dot_cuoi.bsd_tinh_pql,
                    dot_cuoi.bsd_tinh_pbt
                ))
        return list_ltt
