...
class BsdPhiMoiGioi(models.Model):
    ...
    bsd_tien_den = fields.Monetary(string="Số tiền (đến)", help="Số tiền đến",
                                   readonly=True, states={'nhap': [('readonly', False)]})
    bsd_tl_dc = fields.Float(string="HH đặt cọc ", help="Tỷ lệ hoa hồng nhận khi khách đặt cọc", readonly=True,
                             states={'nhap': [('readonly', False)]})
    bsd_tien_dc = fields.Monetary(string="HH đặt cọc (tiền)", help="Tiền hoa hồng nhận khi khách đặt cọc", readonly=True,
                                  states={'nhap': [('readonly', False)]})
    bsd_tl_ttdc = fields.Float(string="HH ký TTĐC", help="Tỷ lệ hoa hồng nhận khi khách ký TTĐC", readonly=True,
                               states={'nhap': [('readonly', False)]})
    bsd_tien_ttdc = fields.Monetary(string="HH ký TTĐC (tiền)", help="Tiền hoa hồng nhận khi khách ký TTĐC", readonly=True,
                                    states={'nhap': [('readonly', False)]})
    bsd_tl_hd = fields.Float(string="HH ký HĐMB", help="Tỷ lệ hoa hồng nhận khi khách ký HĐMB", readonly=True,
                             states={'nhap': [('readonly', False)]})
    bsd_tien_hd = fields.Monetary(string="HH ký HĐMB(tiền)", help="Tiền hoa hồng nhận khi khách ký HĐMB", readonly=True,
                                  states={'nhap': [('readonly', False)]})
