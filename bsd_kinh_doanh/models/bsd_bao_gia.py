...
class BsdBaoGiaLTT(models.Model):
    ...
    bsd_ngay_hh_tt = fields.Datetime(string="Hạn thanh toán", help="Thời hạn thanh toán của đợt thanh toán",
                                     required=True)
    bsd_tien_dot_tt = fields.Monetary(string="Tiền thanh toán", help="Tiền thanh toán của đợt thanh toán", required=True)
    ...
    bsd_ngay_ah = fields.Date(string="Ngày ân hạn", help="Ngày ân hạn thanh toán", required=True)
    bsd_tinh_phat = fields.Selection([('han_tt', 'Hạn thanh toán'), ('ngay_ah', 'Ngày ân hạn')], string="Tính phạt",
                                     required=True, default="han_tt")
